...
from swk.models import Tracksheet,Zones,SwkBubblePopulation,IitTracksheet,IitbHostelDetails
...
class iitbpopulationSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = IitbHostelDetails
        fields = "__all__"
